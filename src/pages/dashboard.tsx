...
import { Bot, MessageSquare, Users, TrendingUp, Activity } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard title="Total Conversations" value={stats?.totalConversations} icon={MessageSquare} trend={`+${stats?.messagesThisWeek || 0} this week`} isLoading={isLoading} />
